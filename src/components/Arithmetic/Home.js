...
import ModulusCalculator from './ModulusCalculator';
import PowerCalculator from './PowerCalculator';

const calculators = [
  { name: 'Addition Calculator', component: AdditionCalculator },
  { name: 'Subtraction Calculator', component: SubtractionCalculator },
  { name: 'Multiplication Calculator', component: MultiplicationCalculator },
  { name: 'Division Calculator', component: DivisionCalculator },
  { name: 'Average Calculator', component: AverageCalculator },
  { name: 'Modulus Calculator', component: ModulusCalculator },
...
const Home = () => {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.heading}>Arithmetic Calculators</h1>
