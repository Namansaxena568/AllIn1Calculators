...
const ModulusCalculator = () => {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.heading}>Modulus Calculator</h2>
      <input
        type="number"
        placeholder="Enter dividend (integer)"
        value={num1}
      ...
      <input
        type="number"
        placeholder="Enter divisor (integer)"
        value={num2}
