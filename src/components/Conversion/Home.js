...
// Import your conversion calculator components here
import AgeCalculator from './AgeCalculator';
import BillTipCalculator from './BillTipCalculator';
import DateCalculator from './DateCalculator';
import GPACalculator from './GPACalculator';
import HeightConverter from './HeightConverter';
import HourToMinuteSeconds from './HourToMinuteSeconds';
import LengthConverter from './LengthConverter';
import PasswordGenerator from './PasswordGenerator';

const calculators = [
  { name: 'Age Calculator', component: AgeCalculator },
  { name: 'Bill & Tip Calculator', component: BillTipCalculator },
  { name: 'Date Calculator', component: DateCalculator },
  { name: 'GPA Calculator', component: GPACalculator },
  { name: 'Height Converter', component: HeightConverter },
  { name: 'Hour to Minute & Seconds', component: HourToMinuteSeconds },
...
const Home = () => {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.heading}>Conversion Calculators</h1>
