...
// Import your financial calculator components here
...
const calculators = [
  { name: 'Simple Interest Calculator', component: SimpleInterestCalculator },
  { name: 'Compound Interest Calculator', component: CompoundInterestCalculator },
  { name: 'Currency Calculator', component: CurrencyCalculator },
  { name: 'Salary Calculator', component: SalaryCalculator },
  { name: 'Retirement Calculator', component: RetirementCalculator },
  { name: 'Sales & Tax Calculator', component: SalesTaxCalculator },
  { name: 'Investment Calculator', component: InvestmentCalculator },
];
...
const Home = () => {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.heading}>Financial Calculators</h1>
